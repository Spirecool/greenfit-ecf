 ...
 */
final class Version20220829093529 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_5BBEC55A67B3B43D ON structures');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_5BBEC55A67B3B43D ON structures (users_id)');
    }
}
